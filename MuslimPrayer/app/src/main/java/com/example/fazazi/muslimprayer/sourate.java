...
import com.layali.codedreamer.muslim.Adapters.souratAdapter;
import com.layali.codedreamer.muslim.Models.Sourat.Sourat;
import com.layali.codedreamer.muslim.Request.SouratRequest;
...
public class sourate extends Fragment {

    private ArrayList<Sourat> recitatorList;
    private RecyclerView recycler;
    private View view;
    public static Context context;
    private souratAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_sourate, container, false);
        ...
        mAdapter = new souratAdapter(view.getContext(), recitatorList, new souratAdapter.RecyclerItemClickListener() {
            @Override
            public void onClickListener(Sourat recitator, int position) {
        ...
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                if (currentIndex + 1 < recitatorList.size()) {
                    Sourat next = recitatorList.get(currentIndex + 1);
                    changeSelectedSong(currentIndex + 1);
                    prepareSong(next);
                } else {
                    Sourat next = recitatorList.get(0);
    ...
    private void getRecitatorList() {
        ...
        SouratRequest request = new SouratRequest(queue);

        request.getSongList(new SouratRequest.RecitatorInteface() {
            @Override
            public void onSuccess(ArrayList<Sourat> sourats) {
    ...
    private void refreshContent() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                mAdapter = new souratAdapter(view.getContext(), recitatorList, new souratAdapter.RecyclerItemClickListener() {
                    @Override
                    public void onClickListener(Sourat song, int position) {
                        changeSelectedSong(position);
                        prepareSong(song);
                    }
                });
    ...
    private void prepareSong(Sourat song) {
    ...
    private void notifyPlayer(Sourat song) {
        ...
        iv_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mediaPlayer.isPlaying() && mediaPlayer != null) {
                    ...
                    if (firstLaunch) {
                        Sourat song = recitatorList.get(0);
                        changeSelectedSong(0);
                        prepareSong(song);
                    } else {
                        mediaPlayer.start();
        ...
        iv_previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mediaPlayer != null) {
                    ...
                    if (currentIndex - 1 >= 0) {
                        Sourat previous = recitatorList.get(currentIndex - 1);
                        changeSelectedSong(currentIndex - 1);
